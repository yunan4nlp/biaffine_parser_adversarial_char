...
class Configurable(object):
    ...
    def save_char_vocab_path(self):
        return self._config.get('Save','save_char_vocab_path')
    @property
    def load_dir(self):
    ...
    def load_char_vocab_path(self):
        return self._config.get('Save', 'load_char_vocab_path')
    @property
    def use_char(self):
        return self._config.getboolean('Network','use_char')
    @property
    def start_adversarial(self):
        return self._config.getint('Network','start_adversarial')
    @property
    ...
    @property
    def char_lstm_hiddens(self):
        return self._config.getint('Network','char_lstm_hiddens')
    @property
    ...
    @property
    def alpha(self):
        return self._config.getfloat('Optimizer','alpha')
    @property
    def classifier_learning_rate(self):
        return self._config.getfloat('Optimizer','classifier_learning_rate')
